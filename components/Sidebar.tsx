...
export default function Sidebar() {
  ...
  const canAccessItem = useCallback(async (item: SidebarItem): Promise<boolean> => {
  ...
  }, [email, isUserAdmin, permissions, permissionsLoaded]);
  ...
  }, [email, permissions, permissionsLoaded, isUserAdmin, canAccessItem]);
      ...
      >
        ...
        <div className="p-6 pt-4 flex-shrink-0 border-t border-primary-border space-y-2">
          ...
          <button
            ...
            className={`sidebar-item w-full text-left transition-all duration-200 ${todayDeadlinesCount > 0
